...
public class ProtocolConstants {
    ...
    static {
        REGISTRIES = read("registries.nbt", tag -> {
    ...
    @SneakyThrows
    private static <T> T read(final String name, final Function<CompoundTag, T> mapper) {
    ...
    public static long getChunkSectionBitMask() {
        long l = 0;
