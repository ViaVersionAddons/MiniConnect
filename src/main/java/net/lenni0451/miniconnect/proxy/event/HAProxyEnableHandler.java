    ...
    public void onProxy2ServerChannelInitialize(final Proxy2ServerChannelInitializeEvent event) {
        ...
        event.getChannel().pipeline().addFirst("miniconnect-", new ChannelInboundHandlerAdapter() {
            ...
            public void channelActive(ChannelHandlerContext ctx) throws Exception {
                ...
                ctx.writeAndFlush(HAProxyUtil.createMessage(proxyConnection.getC2P(), ctx.channel(), ProtocolConstants.PROTOCOL_VERSION)).addListener(ChannelFutureListener.FIRE_EXCEPTION_ON_FAILURE);
            }
        });
